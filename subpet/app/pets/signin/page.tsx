    ...
    return (
      <>
        {isOpen ? (
          ...
          <div className="bg-white border rounded-lg flex flex-col items-center justify-content w-2/3 p-2 mt-10">
            <div className="mt-20 flex flex-col justify-content items-center">
              <div className="text-3xl">Get Sign-in Rewards</div>
              <Image
              ...
              />
              <button
                className="bg-[#E7E7E7] bordered rounded-md p-1 mt-5 w-1/2"
